...
const posts: Post[] = [
  {
    ...
    description: 'Exploring the intersection of functionality and aesthetics in modern workspace design. How minimalism meets productivity.',
  ...
  },
  {
    ...
    description: 'A study of contemporary architectural forms and their impact on urban landscapes. Where structure meets artistry.',
  ...
  },
  {
    ...
    description: 'Vibrant colors and fluid forms come together in this exploration of abstract digital art and creative expression.',
  ...
  },
  {
    ...
    description: 'Capturing the serene beauty of natural landscapes and the majesty of mountain ranges in golden hour light.',
  ...
  },
  {
    ...
    description: 'Diving deep into the world of software development and the technologies shaping our digital future.',
  ...
  },
  {
    ...
    description: 'The art of simplicity in interior design. Less is more when it comes to creating peaceful living spaces.',
  ...
  },
  {
    id: 7,
    title: 'Culinary Art',
    description: 'Food photography that celebrates the artistry of plating and the beauty of carefully crafted dishes.',
  ...
  },
  {
    ...
    description: 'Stories from the streets. Documenting the character and culture of cities through candid photography.',
    ...
    tags: ['travel', 'urban', 'photography']
  },
  {
    id: 9,
    title: 'Portrait Series',
    description: 'Creative portraiture exploring identity, expression, and the human condition through visual storytelling.',
...
const allTags = ['all', 'design', 'photography', 'creative', 'art', 'technology', 'travel', 'minimalism'];
